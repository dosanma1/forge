...
import { HttpMethod, HttpMethodStyleConfig } from '../models/node-styling.model';
...
export class HttpMethodStyleService {
  ...
  getStyle(method: string): HttpMethodStyleConfig {
    return this.methodStyles[method as HttpMethod] ?? this.defaultStyle;
  }
