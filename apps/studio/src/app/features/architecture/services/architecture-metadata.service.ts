...
import { NodeColorScheme } from '../../../shared/models/node-styling.model';
 ...
 * This service is architecture-feature-specific.
 */
@Injectable({ providedIn: 'root' })
export class ArchitectureMetadataService {
  private readonly nodeTypeRegistry: Record<
    ArchitectureNodeType,
    NodeTypeMetadata
  > = {
    service: {
  ...
  getColorScheme(type: ArchitectureNodeType): NodeColorScheme {
    return this.nodeTypeRegistry[type]?.colorScheme ?? 'gray';
  }
